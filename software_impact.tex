...
/Author (Awan Afiaz,  Andrey Ivanov, John Chamberlin, David Hanauer, Candace Savonen, Mary J Goldman, Martin Morgan, Michael Reich,  Alexander Getka, Aaron Holmes, Sarthak Pati, Dan Knight,  Paul C. Boutros, Spyriodon Bakas, J. Gregory Caporaso,  Guilherme Del Fiol, Harry Hochheiser, Brian Haas, Patrick D. Schloss, James Eddy, Jake Albrecht, Andrey Fedorov, Levi Waldron, Jeffrey T. Leek, Carrie Wright)
...
\author{
 ...
 Candace L Savonen \\
  Fred Hutchinson Cancer Center
  Seattle, WA 98109 \\
  \texttt{csavonen@fredhutch.org}\\
  \And
Mary J Goldman \\
  University of California Santa Cruz
  Santa Cruz, CA 95064 \\
  \texttt{mgoldman@ucsc.edu}\\
   \And
 Martin Morgan \\
...
\author[1,2]{A. Afiaz} % aafiaz@uw.edu
...
%\author[2]{Leek, J. T.}
%\author[2]{Wright, C.}%cwright2@fredhutch.org
affil[1]{Department of Biostatistics, University of Washington,Seattle, WA}
affil[2]{Fred Hutchinson Cancer Center,Seattle, WA}
...
\author[1]{\bf Carrie Wright} % 0000-0003-1325-6067, email
\author[1]{\bf Qier Meng} % add ORCID, qmeng11@jhmi.edu
\author[2]{\bf Michael R. Breshock} % add ORCID, mbresho1@jhu.edu
\author[2]{\bf Lyla Atta} % 0000-0002-6113-0082, lylaatta@jhmi.edu
\author[1]{\bf Margaret A.\ Taub } % add ORCID, mtaub@jhsph.edu
\author[1]{\bf Leah R. Jager } % 0000-0003-3362-2298, ljager2@jhu.edu
\author[1,3]{\bf  John Muschelli } % add ORCID, jmusche1@jhu.edu
\author[1,*]{\bf Stephanie C.\ Hicks} % 0000-0002-7858-0231, email

\affil[1]{Department of Biostatistics, Johns Hopkins Bloomberg School of Public Health}
\affil[2]{Department of Biomedical Engineering, Johns Hopkins University}
\affil[3]{Streamline Data Science}
\affil[*]{Correspondence to \nolinkurl{shicks19@jhu.edu}}
