...
\begin{table}
 \caption{\textbf{Software health infrastructure enables collecting metrics that can reassure users and funders.}  }
  ...
  \begin{tabular} {|p{0.1\textwidth}|p{0.15\textwidth}|p{0.15\textwidth}|p{0.23\textwidth}|p{0.24\textwidth}|}
    ...
    &   \multirow{3}{*}[-3em]{\shortstack{Without\\ automation}} & \begin{itemize}
    ...
    \end{itemize} &  blah\\
    \cline{2-5}
    & \multirow{5}{*}{ \shortstack{With\\ Automations}} &
    \begin{itemize}
    ...
    \hline
    \multirow{2}{*}{ \shortstack{Development \\ Activity}}
 ...
 &blah blah\\
    \cline{2-5}
    & \multirow{2}{*}{ \shortstack{Automated \\ Testing}} &
    \begin{itemize}
        \item blah blah
        \item blah blah
    \end{itemize} &
